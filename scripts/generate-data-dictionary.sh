...
#   DB_HOST (localhost) DB_PORT (5432) DB_NAME (change_someones_cell) DB_USER (change_someones_cell)
#   DB_PASSWORD (change_someones_cell) DB_SCHEMA (public)
...
DB_NAME="${DB_NAME:-change_someones_cell}"
DB_USER="${DB_USER:-change_someones_cell}"
DB_PASSWORD="${DB_PASSWORD:-change_someones_cell}"
DB_SCHEMA="${DB_SCHEMA:-public}"

export PGPASSWORD="$DB_PASSWORD"

# relkind 'v' is included alongside 'r' even though this schema currently has no views: one added later
# would otherwise be invisible to every consumer of the CSV.
